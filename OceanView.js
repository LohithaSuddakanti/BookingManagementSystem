...
import ORoom1Image from './assects/ORoom1.jpeg'; // Import Room1.jpg
import ORoom2Image from './assects/ORoom2.jpeg';
import ORoom3Image from './assects/ORoom3.jpeg';
import './View.css';
    ...
    <div className="booking-container">
      ...
      <div className="booking-images">
        <div className="booking">
          ...
          />
          <img src={ORoom1Image} alt="ORoom 1" className={selectedRoom === 'room1' ? 'highlight' : ''} />
          <p>Location: Nagpur</p>
        ...
        <div className="booking">
          ...
          />
          <img src={ORoom2Image} alt="ORoom 2" className={selectedRoom === 'room2' ? 'highlight' : ''} />
          <p>Location: Nagpur</p>
          <p>Price: Rs 2050 per day</p>
        </div>
        <div className="booking">
          ...
          />
          <img src={ORoom3Image} alt="ORoom 3" className={selectedRoom === 'room3' ? 'highlight' : ''} />
          <p>Location: Nagpur</p>
          <p>Price: Rs 2050 per day</p>
        </div>
      </div>
