...
import GRoom1Image from './assects/GRoom1.jpeg'; // Import Room1.jpg
import GRoom2Image from './assects/GRoom2.jpg';
import Groom3Image from './assects/Groom3.jpeg';
import './View.css';
    ...
    <div className="booking-container">
      ...
      <div className="booking-images">
        <div className="booking">
          ...
          />
          <img src={GRoom1Image} alt="GRoom 1" className={selectedRoom === 'room1' ? 'highlight' : ''} />
          <p>Location: Nagpur</p>
        ...
        <div className="booking">
          ...
          />
          <img src={GRoom2Image} alt="GRoom 2" className={selectedRoom === 'room2' ? 'highlight' : ''} />
          <p>Location: Nagpur</p>
          <p>Price: Rs 2050 per day</p>
        </div>
        <div className="booking">
          ...
          />
          <img src={Groom3Image} alt="Groom 3" className={selectedRoom === 'room3' ? 'highlight' : ''} />
          <p>Location: Nagpur</p>
          <p>Price: Rs 2050 per day</p>
        </div>
      </div>
